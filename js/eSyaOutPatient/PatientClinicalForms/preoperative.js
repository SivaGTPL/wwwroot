...
//$(document).ready(function () {
    ...
    $.when(Utils_ClinicalCharts.populateClinicalTemplate("PO1"))
        ...
        .then(Utils_ClinicalCharts.populateClinicalTemplate("PO8"))
        .then(Utils_ClinicalCharts.gridClinicalCharts("BM"))
        .then(getClinicalInformation("PO1,PO3,PO7,PO8", function (data) {
...
var Utils_ClinicalCharts = {
        ...
        $.get(getBaseURL() + '/PatientClinicalForms/GetInformationValueView',
            {
                ...
                $.getJSON(getBaseURL() + "/json/eSyaOutPatient/preoperative.json",
                    function (data) {
                        cl_catalog = data;
                        var i = 0;
    ...
    populateClinicalTemplate: function (type) {
        ...
        return new Promise(function (resolve) {
            $.getJSON(getBaseURL() + "/json/eSyaOutPatient/preoperative.json", function (data) {
                var i = 0;
                var d = data.filter(element => element.cltype === type);
                    ...
                    $.each(item_nav.item, function (keys, item_control) {
                        ...
                        if ($('#lblGender').html() === item_control.specific_to || IsStringNullorEmpty(item_control.specific_to)) {
                            ...
                            if (item_control.valuetype === "checklist_l") {
                                section_item += "<div class='col-10 pl-0' style='margin-bottom: 15px;'>";
                                section_item += "<label class='lblCheck' for='" + item_control.controlid + "'>";
                                ...
                                section_item += "<span class=''>" + item_control.name + "</span>";
                                section_item += "</label>";
                                section_item += "<div class='row  pl-4 pt-3' id='childs_" + item_control.controlid + "' style='display:none;'>";
                ...
                if (type === "PO6")
                    $("#dvConsultationsTemplate").html(section_item);
                if (type === "PO7")
...
function addinv(value) {
    ...
    setTimeout(
        function () {
            ...
            //}
            //if (value === 'LA') {
                Utils_ClinicalCharts.onChange_Combox('INV-1');
            //}
