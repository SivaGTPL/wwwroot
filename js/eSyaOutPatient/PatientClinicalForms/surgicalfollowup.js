...
var l_comp = {
    ...
    '2': 'DVT',
    '3': 'PE',
    '4': 'porto-mesenteric thrombo-embolism',
    '5': 'constipation',
    '6': 'dehydration',
    '7': 'hypoglycemia',
    '8': 'Ventral',
    ...
    '16': 'heart burn',
    '17': 'regurgitation',
    '18': 'atypical symptoms',
    '19': 'gastritis',
    '20': 'Barrettes',
    '21': 'biliary reflux',
    '22': 'Hemorrhage',
    '23': 'gastointestinal leak',
    '24': 'gastointestinal obstruction',
    '25': 'persistent vomiting',
    '26': 'Wound infection',
    '27': 'intra-abdominal collection',
    '28': 'intra-abdominal abscess',
    '29': 'early pregnancy',
    '30': 'menstrual problems',
    '31': 'marginal ulcers',
    '32': 'candy cane syndrome',
    '33': 'dumping syndrome',
    '34': 'diarrhea',
    '35': 'afferent loop syndrome',
    '36': 'jaundice',
    '37': 'biliary cholic',
    '38': 'acute cholecystitis',
    '39': 'acute cholangitis',
    '40': 'pancreatitis',
    '41': 'asymptomatic GB stones',
...
//$(document).ready(function () {
    ...
    $.when(Utils_ClinicalCharts.populateClinicalTemplate("SF1"))
        .then(Utils_ClinicalCharts.populateClinicalTemplate("SF2"))
        .then(Utils_ClinicalCharts.populateClinicalTemplate("SF3"))
        .then(Utils_ClinicalCharts.populateClinicalTemplate("SF4"))
        .then(Utils_ClinicalCharts.populateClinicalTemplate("SF5"))

        .then(Utils_ClinicalCharts.gridClinicalCharts("BM"))
        .then(Utils_ClinicalCharts.gridClinicalCharts("CO"))
        .then(getClinicalInformation("SF1,SF2,SF3,SF4,SF5,PO3", function (data) {
        ...
        .then(Utils_ClinicalCharts.gridClinicalCharts("MDA"))
...
var Utils_ClinicalCharts = {
        ...
        $.get(getBaseURL() + '/PatientClinicalForms/GetInformationValueView',
            {
                ...
                $.getJSON(getBaseURL() + "/json/eSyaOutPatient/surgicalfollowup.json",
                    function (data) {
                        cl_catalog = data;
                        var i = 0;
                        ...
                        if (type === "MED") {
                            ...
                            $.each(t, function (ky, type) {
                                ...
                                $('#jqgmedMED-' + type.value).jqGrid({
                                    ...
                                    forceFit: true,
                                    loadComplete: function () {
                                        $(this).jqGrid('hideCol', ["edit"]);
                                       // fnJqgridSmallScreen('#jqgmedMED-' + type.value);
                                    }
                            ...
                            $.each(t, function (ky, type) {
                                ...
                                $('#jqginvINV-' + type.value).jqGrid({
                                    ...
                                    loadComplete: function () {
                                        $(this).jqGrid('hideCol', ["edit"]);
                                        //fnJqgridSmallScreen('#jqginvINV-' + type.value);
                                    }
                                ...
                                if (type.value === 'LA') {
                                    ...
                                    $('#jqginvINV-LA1').jqGrid({
                                        ...
                                        loadComplete: function () {
                                            $(this).jqGrid('hideCol', ["edit"]);
                                            //fnJqgridSmallScreen('jqginvINV-LA1');
                                        }
                            ...
                            $("#jqgMedicalAdvice").jqGrid('GridUnload');
                            $("#jqgMedicalAdvice").jqGrid({
                                data: gv_data,
                                datatype: "local",
                                colNames: gv_colNames,
                                colModel: gv_colModel,
                                pager: "#jqpMedicalAdvice",
                                rowNum: 10000,
                                loadonce: false,
                                viewrecords: true,
                                gridview: true,
                                ...
                                forceFit: true,
                                loadComplete: function () {
                                    //fnJqgridSmallScreen('jqgMedicalAdvice');
                                }
                            }).jqGrid('navGrid', '#jqpMedicalAdvice', { add: false, edit: false, search: false, del: false, refresh: false });
                            fnRefreshGridWidth();
                            ...
                            $("#jqgCO-GRID").jqGrid({
                                ...
                                forceFit: true,
                                loadComplete: function () {
                                   // fnJqgridSmallScreen('jqgCO-GRID');
                                }
                            }).jqGrid('navGrid', '#jqpCO-GRID', { add: false, edit: false, search: false, del: false, refresh: false });
                            fnRefreshGridWidth();
    ...
    populateClinicalTemplate: function (type) {
        ...
        return new Promise(function (resolve) {
            $.getJSON(getBaseURL() + "/json/eSyaOutPatient/surgicalfollowup.json", function (data) {
                var i = 0;
                var d = data.filter(element => element.cltype === type);
                        ...
                        if ($('#lblGender').html() === item_control.specific_to || IsStringNullorEmpty(item_control.specific_to)) {
                            ...
                            if (item_control.valuetype === "checklist_l") {
                                if (item_control.controlid.startsWith('PO3')) {
                                    section_item += "<div class='col-12 pl-0' id='childs_" + item_control.controlid + "' style='margin-bottom: 15px;'>";
                                    section_item += "<div class='col-lg-12 col-md-12 col-sm-12' ><h6 class='main-heading'>" + item_control.name + "</h6><hr></div>";
                                    section_item += "<div class='row pl-2 pr-2 pt-3 m-auto shadowLite'>";
                                    section_item += "<div class='col-lg-4 col-md-6 col-sm-4 pl-0' style='margin-bottom: 15px;' hidden>";
                                    section_item += "<label class='lblCheck' for='" + item_control.controlid + "'>";
                                    section_item += "<input id='" + item_control.controlid + "' class='' type='checkbox' disabled />";
                                    section_item += "<span class=''>" + item_control.name + "</span>";
                                    section_item += "</label></div>";
                                    $.each(item_control.child, function (keys, chd) {
                                        if (chd.controlid.startsWith('PO3')) {
                                            if (chd.valuetype === "checklist") {
                                                ...
                                                section_item += "<input id='" + chd.controlid + "' class='' type='checkbox' disabled />";
                                            ...
                                            if (chd.valuetype === "text") {
                                                ...
                                                section_item += "<input id='" + chd.controlid + "' class='form-control' type='text' readonly/>";
                                                section_item += "</div></div>";
                                            }
                                            if (chd.valuetype === "textarea") {
                                                section_item += "<div class='col-lg-4 col-md-6 col-sm-12 pl-0'><div class= 'form-group'>";
                                                section_item += "<label>" + chd.name + "</label>";
                                                section_item += "<textarea id='" + chd.controlid + "' class='form-control' rows='3' readonly cols='90'></textarea>";
                                                section_item += "</div></div>";
                                            }
                                            if (chd.valuetype === "combox") {
                                                section_item += "<div class='col-lg-4 col-md-6 col-sm-12 pl-0'><div class= 'form-group'>";
                                                section_item += "<label>" + chd.name + "</label>";
                                                section_item += "<select class='selectpicker form-control' data-container='body' id='" + chd.controlid + "' disabled>";
                                            ...
                                            if (chd.valuetype === "datetime") {
                                                section_item += "<div class='col-lg-4 col-md-6 col-sm-4 pl-0'><div class= 'form-group'>";
                                                section_item += "<label>" + chd.name + "</label>";
                                                section_item += "<input id='" + chd.controlid + "' class='form-control' type='datetime-local' readonly />";
                                                section_item += "</div></div>";
                                            }
                                            if (chd.valuetype === "date") {
                                                section_item += "<div class='col-lg-4 col-md-6 col-sm-4 pl-0'><div class= 'form-group'>";
                                                section_item += "<label>" + chd.name + "</label>";
                                                section_item += "<input id='" + chd.controlid + "' class='form-control' type='date' readonly/>";
                                                section_item += "</div></div>";
                                            }
                                            if (chd.valuetype === "checkbox") {
                                                ...
                                                section_item += "<div class='col-lg-2 col-md-2 col-sm-2 col-6'><label class=''><input type='radio' id='" + chd.controlid + "_y' class='mr-1' name=" + chd.controlid + " value='Y' disabled>Yes</label></div>";
                                                section_item += "<div class='col-lg-2 col-md-2 col-sm-2 col-6'><label class=''><input type='radio' id='" + chd.controlid + "_n' class='mr-1' name=" + chd.controlid + " value='N' disabled>No</label></div>";
                                                section_item += "</div></div>";
                                            }
                                            if (chd.valuetype === "float") {
                                                ...
                                                if (!IsStringNullorEmpty(chd.controlid_2)) {
                                                    section_item += "<input id='" + chd.controlid + "' " + readonly + " class='form-control decimalNumber d-inline' style='width:50px' readonly>  / ";
                                                    section_item += "<input id='" + chd.controlid_2 + "' " + readonly + " class='form-control decimalNumber d-inline' style='width:50px' readonly>";
                                                }
                                                else
                                                    section_item += "<input id='" + chd.controlid + "' " + readonly + " class='form-control decimalNumber d-inline' style='width:80px' readonly onchange=" + eventName + " >";
                            ...
                            if (item_control.valuetype === "combox") {
                                ...
                                $.each(item_control.values, function (keyv, item_values) {
                                    if (item_values.type === 'c') {
                                        f1 = f2;
                                        f2 = f2 + 1;
                                        if (f1 == 0) {
                                            section_item += "<optgroup label='" + item_values.name + "'>";
                                        }
                                        else {
                                            section_item += "</optgroup><optgroup label='" + item_values.name + "'>";
                                        }
                ...
                if (type === "SF1")
                    $("#dvGeneralTemplate").html(section_item);
                if (type === "SF2")
                    $("#dvProgressMedicalHistoryTemplate").html(section_item);
                if (type === "MED")
                    $("#dvMedications").html(section_item);
                if (type === "INV")
                    $("#dvInvestigations").html(section_item);
                if (type === "MDA")
                    $("#dvMedicalAdvice").html(section_item);
                if (type === "BM")
                    $("#dvBodyMeasures").html(section_item);
                if (type === "CO")
                    $("#dvComplications").html(section_item);
                ...
                $.each(d, function (key, item_nav) {
                    $.each(item_nav.item, function (keys, item_control) {
                        ...
                        if (item_control.valuetype === "checklist_l") {
                            ...
                            if (ck_value === true) {                               
                                $.each(item_control.child, function (keys, chd) {
                                    if (!chd.controlid.startsWith('PO3')) {
                                        ...
                                        if (chd.valuetype === "combox") {
                                            if (chd.mandatory === "Y" && (IsStringNullorEmpty($('#' + chd.controlid).val()) || $('#' + chd.controlid).val() === '0')) {
                                                toastr.warning("Please select the " + chd.name);
                                                fnProcessLoading(false);
                                                fValid = false;
                                                return false;
                                            }
                            ...
                            if (ck_value === false && !item_control.controlid.startsWith('PO3')) {
                                $.each(item_control.child, function (keys, chd) {
                                        l_Control.push({
                                            CLType: type,
                                            CLControlID: chd.controlid,
...
function addMedicalAdvice() {
    setDate($('#dpMedicalAdviceDate'), new Date());
    $('#tpMedicalAdviceTime').val(new Date().timeToInput());
    $("#btnSaveMedicalAdvice").show();
    $("#PopupMedicalAdvice").modal('show');
    _isUpdate = false;
    _intTransactionId = 0;

    Utils_ClinicalCharts.populateClinicalTemplate("MDA");
}
function addComplications() {
    setDate($('#dpComplicationsDate'), new Date());
    $('#tpComplicationsTime').val(new Date().timeToInput());
    $("#btnSaveComplications").show();
    $("#PopupComplications").modal('show');
    _isUpdate = false;
    _intTransactionId = 0;

    Utils_ClinicalCharts.populateClinicalTemplate("CO");
}
...
function saveMedicalAdvice() {
    fnProcessLoading(true, "saving");
    $("#btnSaveMedicalAdvice").attr('disabled', true);

    var l_MedicalAdvice = [];

    $.when(Utils_ClinicalCharts.getClinicalTemplate("MDA")).then(function (l_MedicalAdvice) {
        var mda = {
            TransactionID: _intTransactionId,
            UHID: $('#hdUHID').val(),
            VisitNumber: $('#hdAppKey').val(),
            TransactionDate: getDate($('#dpMedicalAdviceDate')),
            TransactionTime: $('#tpMedicalAdviceTime').val(),
            l_ControlValue: l_MedicalAdvice,
            ActiveStatus: true,
            UserID: 0
        };
        saveClinicalInformationData(mda, function (result) {
            fnProcessLoading(false);
            $("#btnSaveMedicalAdvice").attr('disabled', false);
            if (result) {
                $("#PopupMedicalAdvice").modal('hide');

                Utils_ClinicalCharts.gridClinicalCharts("MDA");
            }
        });
...
function saveComplications() {
    fnProcessLoading(true, "saving");
    $("#btnSaveComplications").attr('disabled', true);

    var l_Complications = [];

    $.when(Utils_ClinicalCharts.getClinicalTemplate("CO")).then(function (l_Complications) {
        var bm = {
            TransactionID: _intTransactionId,
            UHID: $('#hdUHID').val(),
            VisitNumber: $('#hdAppKey').val(),
            TransactionDate: getDate($('#dpComplicationsDate')),
            TransactionTime: $('#tpComplicationsTime').val(),
            l_ControlValue: l_Complications,
            ActiveStatus: true,
            UserID: 0
        };
        saveClinicalInformationData(bm, function (result) {
            fnProcessLoading(false);
            $("#btnSaveComplications").attr('disabled', false);
            if (result) {
                $("#PopupComplications").modal('hide');

                Utils_ClinicalCharts.gridClinicalCharts("CO");
            }
        });
...
function saveSurgicalFollowupInformation(l_data, callback) {
...
function fnSaveSurgicalFollowup() {
    fnProcessLoading(true, "saving");
    $("#btnSaveSurgicalFollowup").attr('disabled', true);
    var l_SF = [];
    var l_SF1 = [];
    var l_SF2 = [];

    $.when(Utils_ClinicalCharts.getClinicalTemplate("SF1")).then(function (l_SF1) {
        l_SF = l_SF.concat(l_SF1);
    });
    $.when(Utils_ClinicalCharts.getClinicalTemplate("SF2")).then(function (l_SF2) {
        l_SF = l_SF.concat(l_SF2);
    })
        .then(function () {
            var sf = {
            ...
            saveSurgicalFollowupInformation(sf, function (result) {
                fnProcessLoading(false);
                $("#btnSaveSurgicalFollowup").attr('disabled', false);
            });
        });
...
function editClinicalCharts(type, e, actiontype) {
    if (type === "INV")
        ...
        editMDAValuesCharts(e, actiontype);
    else if (type === "BM")
        editBMValuesCharts(e, actiontype);
    else if (type === "CO")
        editCOValuesCharts(e, actiontype);
}
...
function editMDAValuesCharts(e, actiontype) {
    var rowid = $(e.target).parents("tr.jqgrow").attr('id');
    var rowData = $('#jqgMedicalAdvice').jqGrid('getRowData', rowid);
    $("#btnSaveMedicalAdvice").hide();
    $("#PopupMedicalAdvice").modal('show');
    _isUpdate = true;
    _intTransactionId = rowData.TransactionID;
    ...
    getClinicalInformationByID(rowData.TransactionID, function (data) {
        $.each(data, function (key, val) {
            setDate($('#dpMedicalAdviceDate'), val.TransactionDate);
            $('#tpMedicalAdviceTime').val(new Date(val.TransactionDate).timeToInput());
        });

        $.when(Utils_ClinicalCharts.populateClinicalTemplate("MDA")).then(function () {
            Utils_ClinicalCharts.setClinicalTemplate(data);
        });
...
function editCOValuesCharts(e, actiontype) {
    var rowid = $(e.target).parents("tr.jqgrow").attr('id');
    var rowData = $('#jqgCO-GRID').jqGrid('getRowData', rowid);
    $("#btnSaveComplications").hide();
    $("#PopupComplications").modal('show');
    _isUpdate = true;
    _intTransactionId = rowData.TransactionID;
    ...
    getClinicalInformationByID(rowData.TransactionID, function (data) {
        $.each(data, function (key, val) {
            setDate($('#dpComplicationsDate'), val.TransactionDate);
            $('#tpComplicationsTime').val(new Date(val.TransactionDate).timeToInput());
        });

        $.when(Utils_ClinicalCharts.populateClinicalTemplate("CO")).then(function () {
            Utils_ClinicalCharts.setClinicalTemplate(data);
        });
