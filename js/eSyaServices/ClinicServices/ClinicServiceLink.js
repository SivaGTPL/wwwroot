...
function fnLoadClinicServiceLink() {
    ...
    $("#jqgClinicServiceLink").jqGrid({
        url: getBaseURL() + '/ClinicServices/GetClinicServiceLinkByBKey?businessKey=' + $('#cboBusinessKey').val(),
        datatype: 'json',
        mtype: 'GET',
...
function fnLoadConsultationType() {
    ...
    $.ajax({
        url: getBaseURL() + '/ClinicServices/GetConsultationTypeByBKeyClinicType',
        data: {
...
function fnSaveClinicServiceLink() {
    if ($("#cboClinicType").val()=="0") {
        toastr.warning("Please Select Clinic Type");
        return;
    }
    ...
    $.ajax({
        url: getBaseURL() + '/ClinicServices/AddClinicServiceLink',
        type: 'POST',
        datatype: 'json',
        data: obj,
