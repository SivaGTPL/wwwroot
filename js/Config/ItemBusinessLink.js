...
function fnGridLoadItemBusinessLink() {
    ...
    $("#jqgItemBusinessLink").jqGrid({
        ...
        shrinkToFit: true,
        forceFit: true,
        scrollOffset: 0, caption: 'Item Business Link ',
        loadComplete: function (data) {
         fnJqgridSmallScreen("jqgItemBusinessLink");
        },
