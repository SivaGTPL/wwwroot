...
function fnGridLoadDrugBinInfo() {
    ...
    $("#jqgDrugBinInfo").jqGrid({
        url: getBaseURL() + '/DrugAttributes/GetDrugBinInfo?BusinessKey=' + $("#cboBusinessKey").val() + '&StoreCode=' + $("#cboStore").val(),
        datatype: 'json',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        jsonReader: { repeatitems: false, root: "rows", page: "page", total: "total", records: "records" },
        colNames: [localization.BusinessKey, localization.DrugCode, localization.DrugBrand, localization.StoreCode, localization.MaximumStockLevel, localization.ReorderLevel, localization.SafetyStockLevel, localization.MinimumStockLevel, localization.BinInfo, localization.Active],//, "Actions"],
        colModel: [
            ...
            {
                name: "BinInfo", width: 50, editable: true, editoptions: {
...
function fnSaveDrugBinInfo() {
    ...
    $.ajax({
        url: getBaseURL() + '/DrugAttributes/InsertOrUpdateDrugBinInfo',
        type: 'POST',
        datatype: 'json',
        data: { dr_bi: obj },
