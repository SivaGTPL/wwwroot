...
var Utils_ClinicalCharts = {
        ...
        $.get(getBaseURL() + '/ClinicalForms/GetInformationValueView',
            {
                ...
                $.getJSON(getBaseURL() + "/json/PatientManagement/triage.json",
                    function (data) {
                        cl_catalog = data;
                        var i = 0;
    ...
    populateClinicalTemplate: function (type) {
        ...
        return new Promise(function (resolve) {
            $.getJSON(getBaseURL() + "/json/PatientManagement/triage.json", function (data) {
                var i = 0;
                var d = data.filter(element => element.cltype === type);
...
function saveClinicalInformation(l_data, callback) {
    var url = getBaseURL() + '/ClinicalForms/InsertIntoClinicalInformation';
