...
function fnLoadSchedulerClinic() {
    ...
    $.ajax({
        url: getBaseURL() + '/Doctors/GetClinicConsultantIdList?businessKey=' + $('#cboHBusinessKey').val(),
        type: 'POST',
        datatype: 'json',
        async: false,
...
function fnGridLoadDoctorScheduler() {
    ...
    $("#jqgDoctorScheduler").jqGrid({
        url: getBaseURL() + '/Doctors/GetDoctorSchedulerListAll?businessKey=' + $('#cboHBusinessKey').val() + '&clinicId=' + $('#cboHClinic').val() + '&consultationId=' + $('#cboHConsultationType').val() + '&scheduleFromDate=' + getDate($('#dtFromDate')) + '&scheduleToDate=' + getDate($('#dtToDate')),
        datatype: 'json',
        mtype: 'POST',
...
function fnLoadSchedulerSpecialty() {
    ...
    $.ajax({
        url: getBaseURL() + '/Doctors/GetDoctorClinicLinkListbyClinicConsultation?businessKey=' + $('#cboHBusinessKey').val() + '&clinicId=' + $('#cboHClinic').val() + '&consultationId=' + $('#cboHConsultationType').val(),
        type: 'POST',
        datatype: 'json',
        async: false,
        success: function (response) {
...
function fnSaveDoctorScheduler() {
    ...
    var URL = '';
    if (isUpdate === 0)
        URL = getBaseURL() + '/Doctors/InsertIntoDoctorScheduler';
    else
        URL = getBaseURL() + '/Doctors/UpdateDoctorScheduler';
...
function fnDeleteDoctorScheduler() {
    ...
    $.ajax({
        url: getBaseURL() + '/Doctors/ActiveOrDeActiveDoctorScheduler?status=' + a_status + '&businesskey=' + $("#cboHBusinessKey").val() + '&consultationId=' + $("#cboHConsultationType").val()
