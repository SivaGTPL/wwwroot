...
function fnCreateSpecialtyTree() {
    ...
    $.ajax({
        url: getBaseURL() + '/Facilities/Specialty/GetSpecialtyLinkTree?businessKey=' + $('#cboBusinessKey').val(),
...
function fnSpecialtyParameter(specialtyId) {
    ...
    $.ajax({
        url: getBaseURL() + '/Facilities/Specialty/GetSpecialtyParameter?businessKey=' + $('#cboBusinessKey').val() + '&specialtyId=' + specialtyId,
        type: 'POST',
        datatype: 'json',
...
function fnSaveSpecialtyClinicLink() {
    ...
    var URL;
    URL = getBaseURL() + '/Facilities/Specialty/InsertSpecialtyBusinessLinkList';
    $.ajax({
        url: URL,
        type: 'POST',
        datatype: 'json',
